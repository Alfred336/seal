...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>A new contact submission has been recorded on the SealTech website. Here are the details:</p>
            ...
            <a href="{{ route('manage.contact-submissions.index') }}" class="action-button">View in Admin Panel</a>
        </div>
        <div class="footer">
